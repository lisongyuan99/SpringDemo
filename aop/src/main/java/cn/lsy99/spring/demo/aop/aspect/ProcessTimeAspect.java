package cn.lsy99.spring.demo.aop.aspect;
...
//     @Around("@annotation(cn.lsy99.spring.demo01.annotation.ProcessTime)")
    ...
    @Pointcut("execution(* cn.lsy99.spring.demo.aop.controller.DemoController.*(..))")
    public void pc1() {
    }

    @Pointcut("@annotation(cn.lsy99.spring.demo.aop.annotation.ProcessTime)")
    public void pc2() {
    }
